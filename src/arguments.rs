...
pub fn print_help_list() {
    println!("FileQL is a SQL like query language to run on local files");
    println!();
    ...
    println!("-h,  --help                 Print FileQL help");
    println!("-v,  --version              Print FileQL Current Version");
}
